...
![RAK](assets/images/Wisblock.png){: width="400" }
...
| Stock GPS | No | Yes (external module) | Yes |
| WiFi | No | Yes | Yes |
| Screen | 0.96in OLED | 0.96in OLED | 0.96 OLED |
| Est. Battery Life (3000mAh) | ~278 hrs (11 days) | ~10.7 hrs | ~18.75 hrs |
